...
class MerchantportallagomappServiceImpl(merchantRiskScoreDetailRepo: MerchantRiskScoreDetailRepo,
  ...
  override def getTransactions(txnType: String, merchantId: String): ServiceCall[NotUsed, List[MerchantTransactionResp]] = ServerServiceCall { req =>
  ...
  override def getTransactionsBySearch(txnType: String, merchantId: String): ServiceCall[TransactionFilterReq, List[MerchantTransactionResp]] = ServerServiceCall { req =>
