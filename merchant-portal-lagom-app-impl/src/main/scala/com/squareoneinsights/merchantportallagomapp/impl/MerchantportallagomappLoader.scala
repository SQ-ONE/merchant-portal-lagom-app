...
import com.squareoneinsights.merchantportallagomapp.impl.repository.{BusinessImpactRepo, MerchantLoginRepo, MerchantOnboardRiskScore, MerchantRiskScoreDetailRepo, MerchantTransactionRepo, PartnerRepo}
...
abstract class MerchantportallagomappDevApplication(context: LagomApplicationContext)
  ...
  lazy val partnerRepo = wire[PartnerRepo]
